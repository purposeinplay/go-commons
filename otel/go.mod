module github.com/purposeinplay/go-commons/otel
...
require (
	...
	github.com/purposeinplay/go-commons/grpc v0.0.31
...
require (
	...
	github.com/purposeinplay/go-commons/errors v0.0.14 // indirect
